...
import com.messages.MainActivity
import com.messages.ui.theme.AfterCallReturnState
...
class AfterCallActivity : AppCompatActivity() {
    ...
    private fun updateFromIntent(intent: Intent): Boolean {
        ...
        // longer needed.
        com.messages.NotificationHelper.cancelAfterCallFullScreenNotification(this)
        return true
    }
