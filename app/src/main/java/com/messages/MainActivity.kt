...
import com.messages.ads.UmpConsentManager
import com.messages.navigation.AppNavigation
...
class MainActivity : AppCompatActivity() {
    ...
    private fun handleIntent(intent: Intent) {
        if (intent.getBooleanExtra("navigate_to_chat", false)) {
            ...
            deepLinkRoute = com.messages.navigation.Routes.Chat.createRoute(threadId, address, contactName, forwardText = forwardText)
        }
    }
}