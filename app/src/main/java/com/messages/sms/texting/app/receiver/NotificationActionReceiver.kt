...
class NotificationActionReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_MARK_READ = "com.messages.sms.texting.app.action.NOTIF_MARK_READ"
        const val ACTION_DELETE = "com.messages.sms.texting.app.action.NOTIF_DELETE"
        const val ACTION_REPLY = "com.messages.sms.texting.app.action.NOTIF_REPLY"
        const val ACTION_COPY_OTP = "com.messages.sms.texting.app.action.NOTIF_COPY_OTP"
