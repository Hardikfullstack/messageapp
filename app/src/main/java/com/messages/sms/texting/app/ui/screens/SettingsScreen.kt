...
import com.messages.sms.texting.app.ui.components.CustomSwitch
...
import com.messages.sms.texting.app.ui.components.dialogs.DeleteOldMessagesDialog
import com.messages.sms.texting.app.ui.components.dialogs.DisableAfterCallDialog
import com.messages.sms.texting.app.ui.components.dialogs.RadioOptionDialog
import com.messages.sms.texting.app.ui.components.dialogs.RateUsDialog
import com.messages.sms.texting.app.ui.theme.AfterCallState
import com.messages.sms.texting.app.ui.theme.DelayedSendingState
import com.messages.sms.texting.app.ui.theme.DeleteOldMessagesState
import com.messages.sms.texting.app.ui.theme.DeliveryConfirmationState
import com.messages.sms.texting.app.ui.theme.FontSizeState
import com.messages.sms.texting.app.ui.theme.Inter
import com.messages.sms.texting.app.ui.theme.LanguageState
import com.messages.sms.texting.app.ui.theme.MmsCompressionState
import com.messages.sms.texting.app.ui.theme.ThemeState
    ...
    if (showDeleteOldMessagesDialog) {
        DeleteOldMessagesDialog(
            ...
            onNever = {
                ...
                com.messages.sms.texting.app.utils.AlarmScheduler(context).cancelAutoDeleteCheck()
    ...
    if (showDeleteOldMessagesConfirm) {
        ConfirmationDialog(
            ...
            onConfirm = {
                ...
                com.messages.sms.texting.app.utils.AlarmScheduler(context).scheduleAutoDeleteCheck()
    ...
    if (showRateUsDialog) {
        RateUsDialog(
            onRateClick = { stars ->
                ...
                com.messages.sms.texting.app.utils.RateUsHelper.handleRating(context, stars)
            },
