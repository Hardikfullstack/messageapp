...
import com.messages.sms.texting.app.ads.UmpConsentManager
import com.messages.sms.texting.app.navigation.AppNavigation
import com.messages.sms.texting.app.ui.theme.FontSizeState
import com.messages.sms.texting.app.ui.theme.MessagesTheme
...
class MainActivity : AppCompatActivity() {
    ...
    // Dialogs/DropdownMenus/Popups — which spin up their own sub-window and re-derive
    // density from that window's own Resources — pick it up too, not just plain screen content.
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            // startup — temporary, only for inspecting the API response via Logcat for now.
            ...
            // Gathered once, as early as possible — the very first ad request of the session
            ...
            LaunchedEffect(adConfig, canRequestAds) {
                ...
                // Every-4th-back-navigation interstitial (any screen) — gated by the panel's own
    ...
    private fun handleIntent(intent: Intent) {
        if (intent.getBooleanExtra("navigate_to_chat", false)) {
            ...
            deepLinkRoute = com.messages.sms.texting.app.navigation.Routes.Chat.createRoute(threadId, address, contactName, forwardText = forwardText)
        }
    }
}