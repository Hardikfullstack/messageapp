...
fun OnboardingScreen(
    ...
    // run their course — the dialog shown is for whichever of them is still missing first.
    ...
    val notificationLauncher = rememberLauncherForActivityResult(
        ...
        // Always continue to the next step in the sequence regardless of the result — every
