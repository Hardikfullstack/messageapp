package com.messages.sms.texting.app.navigation
...
import com.messages.sms.texting.app.ui.screens.SplashScreen
import com.messages.sms.texting.app.ui.screens.OnboardingScreen
import com.messages.sms.texting.app.ui.screens.PermissionScreen
import com.messages.sms.texting.app.ui.screens.DefaultSmsScreen
import com.messages.sms.texting.app.ui.screens.DashboardScreen
import com.messages.sms.texting.app.ui.screens.SettingsScreen
import com.messages.sms.texting.app.ui.screens.ArchivedScreen
import com.messages.sms.texting.app.ui.screens.StarredMessagesScreen
import com.messages.sms.texting.app.ui.screens.ChatScreen
import com.messages.sms.texting.app.ui.screens.ChatDetailsScreen
import com.messages.sms.texting.app.ui.screens.ContactNotificationScreen
import androidx.compose.animation.AnimatedContentTransitionScope
import androidx.compose.animation.EnterTransition
import androidx.compose.animation.ExitTransition
import androidx.compose.animation.core.tween
import androidx.compose.runtime.LaunchedEffect
import com.messages.sms.texting.app.ui.screens.SearchScreen
import com.messages.sms.texting.app.ui.screens.BlockedMessagesScreen
import com.messages.sms.texting.app.ui.screens.BackupRestoreScreen
import com.messages.sms.texting.app.ui.screens.NewChatScreen
import com.messages.sms.texting.app.ui.screens.ScheduledMessagesScreen
import com.messages.sms.texting.app.ui.screens.AddGroupNameScreen
import com.messages.sms.texting.app.ui.screens.ChooseLanguageScreen
...
import com.messages.sms.texting.app.ads.GlobalBackAdManager
import com.messages.sms.texting.app.ui.components.dialogs.OfflineDialog
...
fun AppNavigation(deepLinkRoute: String? = null, onDeepLinkConsumed: () -> Unit = {}) {
    ...
    if (isMaintenanceOn) {
        com.messages.sms.texting.app.ui.components.dialogs.MaintenanceDialog(message = adConfig?.result?.extra_data_1_message)
    }
    ...
    val showAdLoader by com.messages.sms.texting.app.navigation.GlobalAdLoader.isLoading.collectAsState()
    if (showAdLoader) {
        androidx.compose.ui.window.Dialog(
            ...
            com.messages.sms.texting.app.ads.AdLoadingScreen()
        }
    }
    ...
    DisposableEffect(navController) {
        val listener = androidx.navigation.NavController.OnDestinationChangedListener { _, destination, _ ->
            ...
            com.messages.sms.texting.app.utils.AnalyticsManager.logScreenView(screenName)
        }
    ...
    NavHost(
        ...
        composable(Routes.SwipeActions.route) {
            BackHandler { navController.popBackStackWithAd() }
            com.messages.sms.texting.app.ui.screens.SwipeActionsScreen(navController = navController)
        }
        composable(Routes.NotificationSettings.route) {
            BackHandler { navController.popBackStackWithAd() }
            com.messages.sms.texting.app.ui.screens.NotificationSettingsScreen(navController = navController)
        }
        composable(Routes.About.route) {
            BackHandler { navController.popBackStackWithAd() }
            com.messages.sms.texting.app.ui.screens.AboutScreen(navController = navController)
        }
        ...
        composable(
            ...
            com.messages.sms.texting.app.ui.screens.LegalWebViewScreen(navController = navController, type = type)
        }
        ...
        composable(
            ...
            com.messages.sms.texting.app.ui.screens.AfterCallScreen(
                address = address,
        ...
        composable(
            ...
            val afterCallReturnInfo = remember {
                com.messages.sms.texting.app.ui.theme.AfterCallReturnState.pending.also {
                    com.messages.sms.texting.app.ui.theme.AfterCallReturnState.pending = null
                }
            }
            if (afterCallReturnInfo != null) {
                BackHandler {
                    navController.popBackStackWithAd()
                    com.messages.sms.texting.app.utils.AfterCallOverlayManager.show(
                        context = context,
            ...
            val members = if (membersJson.isNullOrEmpty()) {
                ...
                try {
                    kotlinx.serialization.json.Json.decodeFromString(
                        kotlinx.serialization.builtins.ListSerializer(com.messages.sms.texting.app.model.GroupMember.serializer()),
                        membersJson
                    )
                } catch (e: Exception) {
                    emptyList()
        ...
        composable(
            ...
            com.messages.sms.texting.app.ui.screens.ImageViewerScreen(
                navController = navController,
                imagePath = imagePath,
                name = name,
                date = date
