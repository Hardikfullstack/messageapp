...
/**
 * Lighter shimmer than the shared list-skeleton one ([com.messages.sms.texting.app.ui.components.shimmerEffect])
 * — ad placeholders sit inside content the user is actively scrolling past, and a loud shimmer
