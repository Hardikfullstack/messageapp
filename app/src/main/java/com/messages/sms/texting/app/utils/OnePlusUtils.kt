 ...
 * Also matches "oppo" — post the OnePlus/Oppo merger, OxygenOS 12+ runs on the same ColorOS-based
...
object OnePlusUtils {
    ...
    /** Best-effort, undocumented components (community-known, not officially published) — covers
