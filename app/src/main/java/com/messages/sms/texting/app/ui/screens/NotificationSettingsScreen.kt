...
import com.messages.sms.texting.app.ui.components.dialogs.NotificationPreviewsDialog
...
private fun openDefaultNotificationChannelSettings(context: Context) {
    com.messages.sms.texting.app.NotificationHelper.ensureDefaultChannelExists(context)
    val intent = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
        Intent(Settings.ACTION_CHANNEL_NOTIFICATION_SETTINGS).apply {
            putExtra(Settings.EXTRA_APP_PACKAGE, context.packageName)
            putExtra(Settings.EXTRA_CHANNEL_ID, com.messages.sms.texting.app.NotificationHelper.DEFAULT_CHANNEL_ID)
        }
    } else {
