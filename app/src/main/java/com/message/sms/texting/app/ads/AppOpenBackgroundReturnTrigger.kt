 ...
 * switched to another app / Home, then came back) â€” separate from [AppOpenCounter]'s cold-start
 * (kill+reopen) cadence, since Splash isn't re-entered on a simple backgroundâ†’foreground return.
...
object AppOpenBackgroundReturnTrigger : Application.ActivityLifecycleCallbacks, DefaultLifecycleObserver {
    ...
    /**
     * One-shot skip for the very next return-to-foreground â€” set this to true right before
    ...
    override fun onStart(owner: LifecycleOwner) {
        ...
        // Don't interrupt onboarding/permission-granting â€” bouncing to system Settings for
        ...
        if (activity is com.message.sms.texting.app.ui.screens.AfterCallActivity) return
    ...
    // Application.ActivityLifecycleCallbacks â€” only currentActivity tracking is needed here.
