 ...
 * (unlike a normal Activity-hosted view) â€” a ComposeView placed in one needs these attached
 * manually, or Compose throws/behaves incorrectly. This is the standard minimal owner for that.
 *
 * Also implements HasDefaultViewModelProviderFactory â€” without it, Compose's viewModel() falls
