...
import com.message.sms.texting.app.model.DeletedMessage
import com.message.sms.texting.app.model.SmsMessage
import com.message.sms.texting.app.model.ScheduledMessage
...
import com.message.sms.texting.app.model.GroupMessage
import com.message.sms.texting.app.model.Reminder
...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // No migrations â€” app isn't published yet, so a schema bump just wipes and recreates
