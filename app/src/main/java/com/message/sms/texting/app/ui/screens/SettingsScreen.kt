...
import com.message.sms.texting.app.ui.components.dialogs.DeleteOldMessagesDialog
import com.message.sms.texting.app.ui.components.dialogs.DisableAfterCallDialog
    ...
    if (showDeleteOldMessagesDialog) {
        DeleteOldMessagesDialog(
            ...
            onNever = {
                ...
                com.message.sms.texting.app.utils.AlarmScheduler(context).cancelAutoDeleteCheck()
    ...
    if (showDeleteOldMessagesConfirm) {
        ConfirmationDialog(
            ...
            onConfirm = {
                ...
                com.message.sms.texting.app.utils.AlarmScheduler(context).scheduleAutoDeleteCheck()
    ...
    if (showRateUsDialog) {
        RateUsDialog(
            onRateClick = { stars ->
                ...
                com.message.sms.texting.app.utils.RateUsHelper.handleRating(context, stars)
            },
